...
InitiatorPassword='Jisort.2021'
PUBLIC_CERT_PATH='/home/josh/lab/projects/jisort.ipn/scripts/cert.cer'

def encrypt_initiator_password_php(cert_path,password):
    """ encrypt initiator password but use php"""
    command="php /home/josh/lab/projects/jisort.ipn/scripts/encrypt.php %s %s"%(cert_path,password)
